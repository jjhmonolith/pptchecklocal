...
3. **문장부호 (punctuation)**: 문장부호 사용법 (매우 신중히 판단 - 의심스러우면 건드리지 마세요)
   ...
   **마침표를 절대 추가하면 안 되는 경우:**
   - 명사구/단어구: "메인 화면", "로그인 버튼", "사용자 설정"
   - "~하기", "~기" 로 끝나는 동명사구: "단원 내용 정리하기", "문제 풀기", "실습하기"
   - "~는 방법", "~의 특징", "~의 종류" 등의 명사구
   - 제목, 라벨, 목차 항목, 버튼 텍스트
   - 불완전한 문구: "~한 화면", "~기능", "~메뉴", "~와 관련된"
   - 체언으로 끝나는 구: "프레젠테이션 제작", "데이터 분석"
   
   **마침표가 필요한 경우 (확실할 때만):**
   - 주어+서술어가 명확한 완전한 문장: "안녕하세요" → "안녕하세요."
   - 완전한 평서문: "오늘 날씨가 좋습니다" → "오늘 날씨가 좋습니다."
...
**마침표 추가 절대 금지사항 (중요!):**
- "~하기", "~기"로 끝나는 모든 표현 ("단원 내용 정리하기", "과제 수행하기")
- "~방법", "~특징", "~종류", "~목적" 등 명사구
- 제목, 라벨, 메뉴, 버튼명, 목차 항목
